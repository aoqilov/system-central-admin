...
import { getCardsStats } from "../api/nfcApi";
...
export default function NfcStatusCards() {
  ...
  return (
    <div className="grid grid-cols-2 desktop:grid-cols-4 gap-3">
      <StatCard icon={LuCreditCard} label="Jami"       value={total}    color="#64748b" />
      <StatCard icon={LuWifi}       label="Faol"       value={active}   color="#22c55e" />
      <StatCard icon={LuShieldOff}  label="Faolsiz"    value={inactive} color="#94a3b8" />
      <StatCard icon={LuBan}        label="Bloklangan" value={blocked}  color="#ef4444" />
    </div>
  );
}
