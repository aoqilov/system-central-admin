...
export function BuxReportTable({ rows, kassas, kartaSold, dateLabel, parkName }: Props) {
  ...
  const stickyFirst: CSSProperties = {
    position: "sticky",
    left: 0,
    zIndex: 1,
      ...
      <div className="overflow-x-auto" style={{ background: "var(--bg-second)" }}>
        <table style={{ borderCollapse: "collapse", width: "100%", minWidth: 500 }}>
          ...
          <tbody>
            ...
            <tr style={{ background: "var(--bg-main)" }}>
              <td style={{ ...tdStyle, ...stickyFirst, fontWeight: 600, color: "#ef4444", background: "var(--bg-main)" }}>
                Возврат карт
              </td>
              {kassas.map((_, ki) => (
