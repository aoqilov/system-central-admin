  ...
  return (
    ...
    >
      ...
      <div className="overflow-x-auto">
        <table
          style={{ borderCollapse: "collapse", width: "100%", minWidth: 1280 }}
        >
          <thead>
            <tr>
              <th
          ...
          <tbody>
            {rows.map((row, ri) => (
              <tr key={row.reportId}>
                ...
                <td style={{ ...tdBase, textAlign: "right", fontWeight: 600, color: "#60a5fa" }}>
                  {fmt(row.price)}
                </td>
                ...
                <td style={{ ...tdBase, borderRight: "none" }}>
                  {row.status === "active" ? (
                    <CusBadge colorPalette="green" dot>
                      Активна
                    </CusBadge>
                  ) : row.status === "stopped" ? (
                    <span
                    ...
                    <div className="flex items-center gap-2">
                      <CusButton
                        size="xs"
                        colorPalette="green"
                        onClick={() => onConfirm(row.reportId)}
                      >
