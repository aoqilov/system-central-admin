...
import { CusBadge, type BadgeRole, type BadgeStatus } from "@/components/ui/badge/CusBadge";
          ...
          <div className="flex flex-wrap gap-2 mt-2.5">
            {roleName && (
              KNOWN_ROLES.includes(roleName as BadgeRole)
                ...
                : <CusBadge size="sm" colorPalette="cyan">{roleName}</CusBadge>
            )}
            <CusBadge status={(STATUS_MAP[employee.status] ?? "inactive") as BadgeStatus} size="sm" />
          </div>
