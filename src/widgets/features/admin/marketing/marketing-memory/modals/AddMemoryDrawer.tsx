...
import { LuImage, LuX, LuUpload, LuBookmark } from "react-icons/lu";
...
import { createMemory } from "../api/marketingMemoryApi";
import type { MemoryCategory } from "../marketing-memory.types";
...
export function AddMemoryDrawer({ open, onClose }: Props) {
