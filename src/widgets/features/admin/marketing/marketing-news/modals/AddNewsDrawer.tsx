...
import { LuImage, LuX, LuUpload, LuNewspaper, LuInfo } from "react-icons/lu";
...
import { createNews } from "../api/marketingNewsApi";
import type { NewsStatus } from "../marketing-news.types";
...
const STATUS_OPTIONS: { value: NewsStatus; label: string; color: string }[] = [
  { value: "planned",  label: "Планируется", color: "#6366f1" },
...
export function AddNewsDrawer({ open, onClose }: Props) {
