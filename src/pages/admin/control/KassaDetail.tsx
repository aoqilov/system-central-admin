...
export default function KassaDetail() {
  ...
  const [localCashierId, setLocalCashier] = useState<number | undefined>(
    undefined,
  );
            ...
            <div className="flex" style={{ minHeight: 148 }}>
              <div className="shrink-0 self-stretch" style={{ width: 120 }}>
                <img
                  src={
                    cashier.avatarUrl ??
                    `https://i.pravatar.cc/150?u=${cashier.id}`
                  }
              ...
              <div className="flex-1 p-4 min-w-0 flex flex-col justify-center">
                ...
                <div className="flex flex-wrap items-center gap-1.5 mt-2.5">
                  <CusBadge
                    status={
                      cashier.status === EmployeeStatus.ACTIVE
                        ? "active"
                        : "fired"
                    }
                    size="sm"
        ...
        <div className="space-y-1">
          {assignCandidates.map((emp) => (
            <button
              ...
              style={{
                background:
                  selectedEmp === emp.id ? "var(--bg-hover)" : "transparent",
