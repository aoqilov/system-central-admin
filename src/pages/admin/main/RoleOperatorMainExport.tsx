...
const ROWS: AttractionRow[] = attractions.map((a) => genRow(a.id, a.name, a.price));
...
export default function RoleOperatorMainExport() {
          ...
          <table style={{ borderCollapse: "collapse", width: "100%", minWidth: 1000 }}>
            ...
            <tbody>
              {ROWS.map((row, ri) => (
                <tr key={row.id}>
                  ...
                  {/* Jami summa */}
                  <td style={{ ...tdBase, textAlign: "right", borderRight: "none" }}>
            ...
            <tfoot>
              <tr style={{ borderTop: "2px solid var(--border-default)", background: "var(--bg-hover)" }}>
                ...
                <td style={{ ...tdBase, textAlign: "right", fontWeight: 700, fontSize: 13, color: "#22c55e", borderRight: "none" }}>
                  {fmt(totalRevenue)}
